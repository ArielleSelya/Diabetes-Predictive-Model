...
for(i in 1:1000){
  ...
  train.result <- predict(train.lda, Sanford.data.diabetes[-samp,])$class
  test.result <- predict(train.lda, Sanford.data.diabetes[samp,])$class
...
#  Training set (Table 3 in manuscript)
